...
public class DetailsFragment extends Fragment implements OnTrackersUpdatedListener, OnLabelPickedListener, OnStorageLocationUpdatedListener {
	...
	private void updateMenuOptions() {
		...
		detailsMenu.getMenu().findItem(R.id.action_start).setVisible(startStop  && torrent.canStart());
		detailsMenu.getMenu().findItem(R.id.action_start_direct).setVisible(startStop && torrent.canStart());
